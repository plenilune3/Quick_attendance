...
public class Attendance extends AppCompatActivity {
    ...
    private class HttpAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        private String body = "cmd=loginUser&userDTO.userId=" + "아이디" + "&userDTO.password=" + "비밀번호" + "&userDTO.localeKey=ko";
...
//            }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for (String cookie : cookies) {
                Log.d("@COOKIE", cookie);
                cookieManager.setCookie("https://elearning.jejunu.ac.kr/MSmartatt.do?cmd=viewAttendCourseList", cookie); //
            }
